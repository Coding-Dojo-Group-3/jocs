            ...
            <div className="mx-52 max-w-full capitalize font-mono pt-1 ">
                <div className="mx-30 py-12 flex flex-col items-center border rounded-lg bg-zinc-50 shadow-lg shadow-sky-500 md:flex-row border-double  border-sky-500  ">
                    <main className="py-8 px-4 sm:p-6 md:py-10 md:px-52 mt-12 w-full">
                        <div className="grid gap-4 col-start-1 col-end-3 row-start-1 sm:mb-6 sm:grid-cols-4 lg:gap-6 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0">
                            <img src={shoe.image?.original} alt="" className="w-full h-60 object-cover rounded-lg sm:h-96 sm:col-span-4 lg:col-span-full" loading="lazy" />
                        </div>
                    </main>
                    ...
                    <div className="px-8  " >
                        ...
                        <div className="relative p-3 m-10 pb-20 col-start-1 row-start-1 flex flex-col rounded-lg bg-gradient-to-t from-black/75 via-black/0 sm:bg-none sm:row-start-2 sm:p-0 lg:row-start-1 divide-y-4 divide-zinc-200/25  h-full  bg-zinc-100">
                            
                            <h5 className="mb-2 mt-10 text-2xl mx-4 font-bold tracking-tight text-gray-900 dark:text-white">{shoe.name}</h5>
                        
                            <label className="mx-4 mb-2 pt-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Color:
                                <span className="mb-3 font-normal text-gray-700 dark:text-gray-400 text-md"> {shoe.colorway}</span>
                            </label>
                            

                            <label className="mx-4 mb-2 pt-4  text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Gender:
                                <span className="mb-3 font-normal text-gray-700 dark:text-gray-400 text-md"> {shoe.gender}'s</span>
                            </label>
                            <label className="mx-4 mb-2 pt-4  text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Retail Price:
                                <span className="mb-3 font-normal text-gray-700 dark:text-gray-400 text-md"> ${shoe.retailPrice}.00</span>
                            </label>
                            <label className="mx-4 mb-2 pt-4  text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Est.Market Value:
                                <span className="mb-3 font-normal text-gray-700 dark:text-gray-400 text-md"> ${shoe.estimatedMarketValue}.00</span>
                            </label>
                            <label className="mx-4 mb-2 pt-4  text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Release Date:
                                <span className="mb-3 font-normal text-gray-700 dark:text-gray-400 text-md"> {moment(shoe.releaseDate).format("DD-MM-YYYY") }</span>
                            </label>
                ...
                <div className="pt-5 ">
                    ...
                    <div className="flex flex-col items-center mx-20 pt-8 mb-20 font-mono pb-10 border-1 bg-gradient-to-r from-sky-200 to-cyan-600 hover:shadow-2xl">
                        ...
                        {shoe.story?
                            <p className="mb-3 font-semibold text-gray-700 dark:text-gray-400">{shoe.story}</p>:
                            <p className="mb-3 font-semibold text-gray-700 dark:text-gray-400">Story is not given...</p>}
                            
                            
                            <p className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">Can Also Find On:</p>
                                <a href={shoe.links?.fightclub} target='_blank' rel="noreferrer" className="font-bold text-sky-100 hover:text-blue-500">FIGHT CLUB</a> 
                                <a href={shoe.links?.goat} target='_blank' rel="noreferrer" className="font-bold text-sky-100 hover:text-blue-500">GOAT</a> 
                                <a href={shoe.links?.stadiumGoods} target='_blank' rel="noreferrer" className="font-bold text-sky-100 hover:text-blue-500">StadiumGoods</a>
                                <a href={shoe.links?.stockX} target='_blank' rel="noreferrer" className="font-bold text-sky-100 hover:text-blue-500">StockX</a>  
                    </div>
                </div>
